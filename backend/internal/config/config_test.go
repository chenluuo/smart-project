...
func TestLoadDefaults(t *testing.T) {
	...
	if !cfg.MQTT.Enabled || cfg.MQTT.BrokerURL != "tcp://localhost:1883" || cfg.MQTT.TopicPrefix != "agri" || cfg.MQTT.ClientID != "smart-agriculture-api" || cfg.MQTT.ThresholdAckTimeout != 2*time.Minute {
